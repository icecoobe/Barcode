...
namespace Barcode._1D
{
    ...
    {
        #region Variables
        private IBarcode ibarcode = new Barcode._1D.Symbologies.Blank();
        ...
        public BarcodeGenerator(string data)
        {
            //constructor
            this.Raw_Data = data;
        }//Barcode
        public BarcodeGenerator(string data, TYPE iType)
        {
            this.Raw_Data = data;
        ...
        {
            using (BarcodeGenerator b = new BarcodeGenerator())
            {
